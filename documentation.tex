...
\lstinputlisting[language=sql, firstline=6, lastline=2]{setup.cql}

Nyní máme vytvořený keyspace a je potřebné vytvořit tabulky, do který následně vložíme data.

\lstinputlisting[language=sql, firstline=11, lastline=30]{setup.cql}

V  tuto chvíli je připraven keyspace a je možné vložit data:

\lstinputlisting[language=sql, firstline=32, lastline=36]{setup.cql}
